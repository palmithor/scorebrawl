/*
    https://shadcn-stepper.vercel.app/
    https://github.com/shadcn-ui/ui/blob/d659b213199c1e2204b0f79749827f0f73df448c/apps/www/content/docs/components/stepper.mdx
*/
"use client";
    ...
    >
      <div
        ...
        className={cn(
          ...
          "flex items-center",
          variant === "line" && "border-s-[3px] data-[active=true]:border-blue-500 py-2 ps-3",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "line" && "flex-col flex-1 border-t-[3px] data-[active=true]:border-blue-500",
